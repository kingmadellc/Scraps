...
public sealed class WardrobePreview:MonoBehaviour {
 ...
 public void Initialize(RawImage target,string look,int coat){
  ...
  model=Instantiate(Resources.Load<GameObject>("Jimothy"),stage.transform);model.transform.localPosition=Vector3.zero;model.transform.localScale=Vector3.one*.22f;
