...
public static class DenFurnishings {
 ...
 public static void Build(Transform parent,List<string> decor){
  ...
  if(decor.Contains("mushroom-lamp")){var p=new Vector3(-12.6f,-2.4f,62.4f);b.Part(PrimitiveType.Cylinder,p+Vector3.up*.33f,new(.10f,.33f,.10f),cream);b.Part(PrimitiveType.Sphere,p+Vector3.up*.65f,new(.52f,.22f,.52f),new(.76f,.34f,.10f),emission:.3f);b.Light(p+Vector3.up*.60f,new(1,.60f,.27f),2.3f,1.5f);}
  ...
  if(decor.Contains("pedalboard")){var p=new Vector3(-17.55f,-2.37f,61.12f);b.Box(p,new(.76f,.045f,.46f),iron);for(int i=0;i<4;i++){var c=p+new Vector3((i-1.5f)*.17f,.06f,0);b.Box(c,new(.14f,.075f,.28f),i%2==0?green:red);b.Part(PrimitiveType.Cylinder,c+new Vector3(0,.055f,-.07f),new(.025f,.02f,.025f),cream);for(int k=0;k<2;k++)b.Part(PrimitiveType.Cylinder,c+new Vector3((k-.5f)*.07f,.05f,.07f),new(.025f,.015f,.025f),iron);}}
