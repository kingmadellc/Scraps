...
public partial class GameUI {
 ...
 void ShowDenShop(int index){
  ...
  DenPageTitle("DECORATE",$"{game.Data.coins} shinies · {index+1}/{pages}");
 ...
 void ShowDenFavorites(int index){
  ...
  DenPageTitle("FAVORITES",$"Pin favorites to your display · {game.Data.favoriteFinds.Count}/8 · {index+1}/{pages}");
