...
public partial class GameUI {
 ...
 void BuildTouchControls(){
  ...
  touchContext=TouchAction("Nearby interaction","search",new(1,0),new(-286,113),100,()=>{if(game.NearCollector||game.NearClothesRail)game.Search();else if(game.AtHome)ShowDen();else game.Search();});touchContextLabel=TouchCaption(touchContext.transform,"SEARCH",-65,140);
