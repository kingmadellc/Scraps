...
public static class MobileWebBuild {
 public static void Build(){
  ...
  // Keep the large linker scratch files beside the project, not on a nearly full system disk.
  string scratch=Path.GetFullPath("../Temp/Emscripten");Directory.CreateDirectory(scratch);Environment.SetEnvironmentVariable("EMCC_TEMP_DIR",scratch);
