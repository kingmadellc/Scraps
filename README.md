...
Unity 6000.3.0f1 / URP survival platformer set around Old Ballard Avenue, with editable Blender character and environment assets. Current prototype: **0.5.1**.

**[Play the public browser build](https://kingmadellc.github.io/JimothySurvival/?v=0.5.1)** on iPhone, iPad, or desktop. No local Mac/server is required. Safari users: landscape, then Play. The first download is about 122 MB; saves stay in this browser on this site.
