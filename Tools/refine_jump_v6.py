...
POSES = [
    (0.00, -.39, -.055, 0.00, 0.00, 0.00, 0.00), # compressed takeoff
    (0.16, -.08, -.045, -.22, .17, .09, .18),     # forepaws reach; hind push/gather
    (0.48, -.11, .035, -.15, .36, -.15, .65),     # hind knees tucked at apex
    (0.76, -.07, .075, -.16, .035, .04, .17),     # forefeet prepare contact
    (0.84, -.43, .040, -.08, 0.00, .02, 0.00),   # landing cushion
...
def refine(rig):
    ...
    report={'version':6,'frames':61,'loop':False,'limb_scale':scale,'max_ankle_gap':0.,'max_knee_gap':0.,'max_solver_error':0.,'max_target_clamp':0.,'max_paw_orientation_error':0.,'mesh_vertex_count':0,'poses':[]}
    previous={}
