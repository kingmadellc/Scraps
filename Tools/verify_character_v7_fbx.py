"""Read-only round trip of exported V7 FBX; independent of Unity rendering."""
...
(root/'Documentation/character-v7-fbx-roundtrip.json').write_text(json.dumps(report,indent=2));print('V7_FBX_ROUNDTRIP_PASS',json.dumps(report))
