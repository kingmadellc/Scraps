"""Compare V7/V8 anatomy, bind skeleton, and every action key. Does not write assets."""
...
a=signature('v7');b=signature('v8');assert a==b,(a,b)
report={'passed':True,'identical_skin_bind_skeleton_and_action_keys':a}
(root/'Documentation/character-v8-preservation.json').write_text(json.dumps(report,indent=2));print(report)
